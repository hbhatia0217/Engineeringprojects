...
songplay_table_create = ("""create table if not exists songplay(songplay_id serial primary key not null, start_time timestamp not null, user_id int not null, level varchar, song_id varchar, artist_id varchar, session_id int, location varchar , user_agent varchar)
""")
...
song_table_insert = ("""insert into songs(song_id,title,artist_id,year,duration)
                        values('SOMZWCG12A8C13C480', 'I Didnt Mean To', 'ARD7TVE1187B99BFB1', 0, 218.93179)
""")

artist_table_insert = ("""insert into artists(artist_id, name,location,latitude, longitude)
                        values('ARD7TVE1187B99BFB1', 'Casual', 'California - LA', 'nan', 'nan')
""")
