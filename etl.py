...
def process_song_file(cur, filepath):
    """Read a song file and insert data to songs and artitst table.
        Agrs: cur(psycopg.cursor): The psycopg2 cursor 
        filepath(str)
    """
    # open song file
...
def process_log_file(cur, filepath):
    # open log file
    """Extrat data from json file and read from filepath"""
